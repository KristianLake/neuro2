...
export default function CompletionModal({ 
  ...
  useEffect(() => {
    const checkAccess = async () => {
      const access = await checkModuleAccess('module-3');
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="text-center">
                ...
                <p className={`text-lg mb-4 ${
                  ...
                  You've completed TypeScript Navigator! {hasNextModuleAccess ? 'Ready to start Syntax Sculptor?' : 'Ready to unlock more content?'}
                </p>
                <p className={`text-sm mb-6 ${
                  ...
                  The Syntax Sculptor module is available for £297, or get the full course for £2,497
                </p>
                  ...
                  <div className="space-y-4">
                    <div className={`rounded-lg p-4 ${
                      ...
                      <div className={`text-sm ${
                        ...
                        Complete Syntax Sculptor: Advanced TypeScript patterns and best practices
                      </div>
                    </div>
