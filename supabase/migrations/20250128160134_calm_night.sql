...
DROP TRIGGER IF EXISTS on_purchase_refund ON purchases CASCADE;
DROP TRIGGER IF EXISTS on_purchase_completion ON purchases CASCADE;
DROP TRIGGER IF EXISTS purchase_status_transition ON purchases CASCADE;

-- Drop existing functions
DROP FUNCTION IF EXISTS handle_purchase_completion() CASCADE;
DROP FUNCTION IF EXISTS check_purchase_status_transition() CASCADE;
DROP FUNCTION IF EXISTS update_purchase_status(uuid, uuid, text, text, integer) CASCADE;
DROP FUNCTION IF EXISTS update_purchase_status_v2(uuid, uuid, text, text, integer) CASCADE;
